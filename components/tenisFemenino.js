...
onElementoPressed(elemento){
  ...
  render(){
    return(
      ...
      <View style={{flex:1}}>
        <MenuTop navigator={this.props.navigator} title="Ranking LTB Femenino" color="#01a9bd"/>
        ...
        <View style={{backgroundColor:'#01a9bd',flexDirection:'row', justifyContent:'space-around'}}>
          <View>
            <Button transparent textStyle={{color:'white'}} onPress={()=>{this.irMasculino()}}>
              MASCULINO
              <Icon style={{color:'white'}} name='ios-male' />
            </Button>
          </View>
          <View>
